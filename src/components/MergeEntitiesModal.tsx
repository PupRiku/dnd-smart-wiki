...
import { FaObjectGroup } from 'react-icons/fa'; // Using a "Group" icon for merging
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., Bioengineer Fibblestib"
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., Bioengineer Fiddlestib"
                  className="mt-1 block w-full rounded-md border-gray-600 bg-gray-700 p-3 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                />
              </div>
              ...
              <div className="flex justify-end gap-4 pt-4">
                ...
                <button
                  type="submit"
                  disabled={isMerging || !sourceName || !targetName}
